...
const ItemModal = () => {
  const { handleClose, handleOverlay, handleModalChange, modalOptions, selectedItem } = useContext(ModalContext);
  ...
  return (
    <div onClick={(event) => handleOverlay(event)} className={`modal modal_type_${previewFormName}`}>
